...
//Enter a tracking number using mouse actions
        ...
        try{
            //store your element as WebElement
            WebElement trackingField = driver.findElement(By.xpath("//*[@class='button tracking-btn']"));
            actions.moveToElement(trackingField).click().perform();
        } catch (Exception e) {
            System.out.println("unable to click on the track button. " + e);
        }//end of tracking input exception
