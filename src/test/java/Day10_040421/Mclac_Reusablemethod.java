...
public class Mclac_Reusablemethod {
...
//Step1: locate the path for readable file that we created in excel
        jxl.Workbook readableBook = jxl.Workbook.getWorkbook(new File("src/main/resources/mcalc.xls"));

//Step 2: create a writable workbook that will mimic the data from readable
        WritableWorkbook writableWorkbook = jxl.Workbook.createWorkbook(new File("src/main/resources/mcalc_Result.xls"),readableBook);
